...
VM_FILE_RESTORE_OPERATOR_CONTROLLER_MANAGER = "vm-file-restore-operator-controller-manager"
...
EXPECTED_VIRT_DEPLOYMENTS_LABELS_DICT_MAP = {
    ...
    VM_FILE_RESTORE_OPERATOR_CONTROLLER_MANAGER: {
        MANAGED_BY_LABEL_KEY: MANAGED_BY_LABEL_VALUE_OLM,
        COMPONENT_LABEL_KEY: "vm-file-restore",
        VERSION_LABEL_KEY: None,
        PART_OF_LABEL_KEY: HCO_PART_OF_LABEL_VALUE,
    },
    VIRT_NETWORK_RESOURCES_INJECTOR: {
        MANAGED_BY_LABEL_KEY: HCO_OPERATOR,
        COMPONENT_LABEL_KEY: VIRT_NETWORK_RESOURCES_INJECTOR,
        VERSION_LABEL_KEY: None,
        PART_OF_LABEL_KEY: HCO_PART_OF_LABEL_VALUE,
    },
